...
class CarPagerActivity : AppCompatActivity() {
    ...
    class CarPagerAdapter(supportFragmentManager: FragmentManager, private val carFragmentList: ArrayList<Fragment>) : FragmentPagerAdapter(supportFragmentManager, FragmentPagerAdapter.BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT) {
