...
class ShowCarFragment : Fragment() {
    ...
    companion object {
        fun newInstance(car : Cars) : ShowCarFragment{
            ...
            bundle.putString("car model", car.carModel)
            bundle.putString("car type", car.carType)
            bundle.putString("production year", car.productionYear.toString())
            bundle.putString("rent price", car.rentPrice.toString())
            ...
            bundle.putString("car plate", car.carPlate)
